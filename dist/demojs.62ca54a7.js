...
!function (t) {
  ...
  if ((!k || "function" != typeof _ || _ === Function.prototype) && (_ = function _() {
    throw TypeError("Incorrect invocation");
  }, k)) for (r in j) {
    a[r] && d(a[r], _);
  }
  if ((!k || !x || x === O) && (x = _.prototype, k)) for (r in j) {
    a[r] && d(a[r].prototype, x);
  }
  if (k && p(w) !== x && d(w, x), i && !l(x, A)) for (r in T = !0, h(x, A, {
    get: function get() {
  ...
  var r = n(37),
    ...
    return function (d, y, v, g) {
      for (var b, m, w = i(d), _ = o(w), x = r(y, v, 3), O = a(_.length), E = 0, A = g || u, S = e ? A(d, O) : n || h ? A(d, 0) : void 0; O > E; E++) {
        if ((p || E in _) && (m = x(b = _[E], E, w), t)) if (e) S[E] = m;else if (m) switch (t) {
          case 3:
            return !0;
  ...
  var r = n(0),
    ...
    return z(t) && "symbol" != _typeof(e) && e in t && String(+e) == String(e);
      ...
      W = function W(t, e) {
    return K(t, e = y(e, !0)) ? c(2, t[e]) : q(t, e);
  },
      J = function J(t, e, n) {
    return !(K(t, e = y(e, !0)) && b(n) && v(n, "value")) || v(n, "get") || v(n, "set") || n.configurable || v(n, "writable") && !n.writable || v(n, "enumerable") && !n.enumerable ? P(t, e, n) : (t[e] = n.value, t);
  };

  i ? (M || (S.f = W, A.f = J, Y(D, "buffer"), Y(D, "byteOffset"), Y(D, "byteLength"), Y(D, "length")), r({
    target: "Object",
    stat: !0,
    forced: !M
  }, {
    ...
    M ? a && (v = e(function (t, e, n, r) {
      return s(t, v, u), T(b(e) ? V(e) ? void 0 !== r ? new y(e, d(n, i), r) : void 0 !== n ? new y(e, d(n, i)) : new y(e) : z(e) ? H(v, e) : x.call(v, e) : new y(p(e)), t, v);
    }), w && w(v, U), O(_(y), function (t) {
      t in v || f(v, t, y[t]);
      ...
      if (b(e)) {
        if (!V(e)) return z(e) ? H(v, e) : x.call(v, e);
        o = e, f = d(n, i);
        var y = e.byteLength;
  ...
  t.exports = function (t, e, n) {
    ...
    if (i(t, "function" != typeof b || !(v || m.forEach && !f(function () {
      ...
      })).prototype = m, m.constructor = w), (A || k) && (x("delete"), x("has"), y && x("get")), (k || E) && x(g), v && m.clear && delete m.clear;
    }
    return _[t] = w, r({
      global: !0,
      forced: w != b
  ...
  t.exports = function (t, e, n, c, p, b, m) {
    ...
    if (j && (w = i(j.call(new t())), d !== Object.prototype && w.next && (f || i(w) === d || (a ? a(w, d) : "function" != typeof w[v] && l(w, v, g)), u(w, E, !0, !0), f && (h[E] = g))), "values" == p && k && "values" !== k.name && (A = !0, T = function T() {
      return k.call(this);
    }), f && !m || S[v] === T || l(S, v, T), h[e] = T, p) if (_ = {
      values: O("values"),
      keys: b ? T : O("keys"),
      entries: O("entries")
    }, m) for (x in _) {
      (y || A || !(x in S)) && s(S, x, _[x]);
    } else r({
      target: e,
      proto: !0,
      forced: y || A
              ...
              for (var f = n - o, h = f % 2 != 0, p = 0, d = 0, y = 0, v = 0, g = 0; g < i; g++) {
                ...
                for (var x = -g + y; x <= g - v; x += 2) {
                  ...
                  if (s[O] = _, _ > n) v += 2;else if (E > o) y += 2;else if (!h && (m = a + f - x) >= 0 && m < u && -1 != l[m]) {
                    var A = l[m];
                    if (w = a + A - m, A >= (_ = n - _)) return r(t, e, A, w);
                  }
                }
              }
  ...
  var r = n(0),
    ...
    return d(n), f(Z, r) ? (n.enumerable ? (f(t, U) && t[U][r] && (t[U][r] = !1), n = m(n, {
      enumerable: b(0, !1)
    })) : (f(t, U) || W(t, U, b(1, {})), t[U][r] = !0), rt(t, r, n)) : W(t, r, n);
  },
      ut = function ut(t, e) {
    d(t);
    var n = v(e),
  ...
  (l || (T((_Y = function Y() {
    ...
    return ot(q(t), t);
  }), S.f = lt, A.f = at, E.f = st, _.f = x.f = ct, O.f = ft, R.f = function (t) {
    return ot(L(t), t);
  }, u && (W(_Y.prototype, "description", {
    configurable: !0,
    get: function get() {
  ...
  var r = n(0),
    ...
    var e,
        ...
        s = l(this),
        c = String(t);
    return e = y(s, RegExp), void 0 === (n = s.flags) && s instanceof RegExp && !("flags" in x) && (n = f.call(s)), r = void 0 === n ? "" : String(n), o = new e(e === RegExp ? s.source : s, r), i = !!~r.indexOf("g"), u = !!~r.indexOf("u"), o.lastIndex = a(s.lastIndex), new S(o, c, i, u);
  };
  ...
  r("replace", 2, function (t, e, n, r) {
    ...
    return [function (n, r) {
      ...
      for (var O, E = "", A = 0, S = 0; S < _.length; S++) {
        x = _[S];

        for (var k = String(x[0]), T = f(h(a(x.index), g.length), 0), j = [], N = 1; N < x.length; N++) {
          j.push(void 0 === (O = x[N]) ? O : String(O));
        }
      ...
      for (var w = 0, _ = 0, x = []; _ < h.length;) {
        ...
        if (null === E || (O = d(s(b.lastIndex + (y ? 0 : _)), h.length)) === w) _ = l(h, _, v);else {
          ...
          for (var A = 1; A <= E.length - 1; A++) {
            if (x.push(E[A]), x.length === m) return x;
          }
  ...
  var r,
      ...
      Y = k.f,
      V = Y,
      K = !!(F && F.createEvent && s.dispatchEvent),
    ...
    if (!t.notified) {
      ...
      X = function X(t, e, n) {
    var r, o;
    K ? ((r = F.createEvent("Event")).promise = e, r.reason = n, r.initEvent(t, !1, !0), s.dispatchEvent(r)) : r = {
      promise: e,
      reason: n
    }, !W && (o = s["on" + t]) ? o(r) : "unhandledrejection" === t && S("Unhandled promise rejection", n);
  },
      Q = function Q(t) {
    O.call(s, function () {
      var e,
  ...
  var r,
      ...
      switch (a = i[h], c) {
        ...
        case et:
          if (a && (k.test(a) || "+" == a || "-" == a || "." == a)) d += a.toLowerCase();else {
            ...
            if (n && (W(t) != f(K, d) || "file" == d && (J(t) || null !== t.port) || "file" == t.scheme && !t.host)) return;
            if (t.scheme = d, n) return void (W(t) && K[t.scheme] == t.port && (t.port = null));
            d = "", "file" == t.scheme ? c = pt : W(t) && o && o.scheme == t.scheme ? c = rt : W(t) ? c = ut : "/" == i[h + 1] ? (c = ot, h++) : (t.cannotBeABaseURL = !0, t.path.push(""), c = bt);
          }
          break;
        ...
        case it:
          if (t.scheme = o.scheme, a == r) t.username = o.username, t.password = o.password, t.host = o.host, t.port = o.port, t.path = o.path.slice(), t.query = o.query;else if ("/" == a || "\\" == a && W(t)) c = at;else if ("?" == a) t.username = o.username, t.password = o.password, t.host = o.host, t.port = o.port, t.path = o.path.slice(), t.query = "", c = mt;else {
            if ("#" != a) {
          ...
          if (!T.test(a)) {
            if (a == r || "/" == a || "?" == a || "#" == a || "\\" == a && W(t) || n) {
              if ("" != d) {
                ...
                t.port = W(t) && _ === K[t.scheme] ? null : _, d = "";
              }
        ...
        case gt:
          if (a == r || "/" == a || "\\" == a && W(t) || !n && ("?" == a || "#" == a)) {
            if (".." === (s = (s = d).toLowerCase()) || "%2e." === s || ".%2e" === s || "%2e%2e" === s ? (X(t), "/" == a || "\\" == a && W(t) || t.path.push("")) : Q(d) ? "/" == a || "\\" == a && W(t) || t.path.push("") : ("file" == t.scheme && !t.path.length && Z(d) && (t.host && (t.host = ""), d = d.charAt(0) + ":"), t.path.push(d)), d = "", "file" == t.scheme && (a == r || "?" == a || "#" == a)) for (; t.path.length > 1 && "" === t.path[0];) {
              t.path.shift();
            }
        ...
        case bt:
          "?" == a ? (t.query = "", c = mt) : "#" == a ? (t.fragment = "", c = wt) : a != r && (t.path[0] += V(a, F));
          break;

        case mt:
          n || "#" != a ? a != r && ("'" == a && W(t) ? t.query += "%27" : t.query += "#" == a ? "%23" : V(a, F)) : (t.fragment = "", c = wt);
          break;
    ...
    var t = O(this),
        ...
        l = t.fragment,
        s = e + ":";
    return null !== o ? (s += "//", J(t) && (s += n + (r ? ":" + r : "") + "@"), s += D(o), null !== i && (s += ":" + i)) : "file" == e && (s += "//"), s += t.cannotBeABaseURL ? a[0] : a.length ? "/" + a.join("/") : "", null !== u && (s += "?" + u), null !== l && (s += "#" + l), s;
  },
      At = function At() {
    var t = O(this),
        e = t.scheme,
    ...
    return "file" != e && W(t) ? e + "://" + D(t.host) + (null !== n ? ":" + n : "") : "null";
  },
      St = function St() {
  ...
  if (i && l(Ot, {
    ...
    }), Bt && s(xt, "revokeObjectURL", function (t) {
  ...
  var q = function () {
    function t(e) {
      !function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
      }(this, t), this.quillJS = e, this.getOperatorsAll.bind(this), this.tags = [new l(this.quillJS).getAction(), new h(this.quillJS).getAction(), new v(this.quillJS).getAction(), new S(this.quillJS).getAction(), new T(this.quillJS).getAction(), new w(this.quillJS).getAction(), new N(this.quillJS).getAction(), new E(this.quillJS).getAction()];
    }
  ...
  function C(t, e) {
    ...
    if ("undefined" == typeof Symbol || null == t[Symbol.iterator]) {
      if (Array.isArray(t) || (_n = U(t)) || e && t && "number" == typeof t.length) {
        _n && (t = _n);
  ...
  var z = function () {
    function t(e, n) {
      !function (t, e) {
        ...
        tilde: "~",
        underscore: "_"
      }, this.ignoreTags = ["PRE"], this.tags = new q(this.quillJS), this.matches = this.tags.getOperatorsAll();
    }
    ...
    return e = t, (n = [{
      ...
      value: function value(t, e, n) {
        ...
        if ("user" === n) {
          var o = t.ops[0] && t.ops[0].retain || 0,
              i = t.ops[0].insert || t.ops[1].insert;

          if (i.length > 1) {
            console.log("start "), window._quill = this.quillJS;

            var a = function a(t) {
              return new Promise(function (e) {
                var n = setInterval(function () {
                  var o = B(r.quillJS.getLine(t), 1)[0];
                  ...
                  if (!r.onFullTextExecute.bind(r)({
                    ...
                    clearInterval(n);
                    var a = B(r.quillJS.getLine(t), 1)[0],
                        u = r.quillJS.getIndex(a);
                    a && a.domNode || e(0);
                    var l = a.domNode.textContent || "";
                    console.log("cancel last text", l, l.length), e(u + l.length + 1);
                  }
              ...
              return regeneratorRuntime.wrap(function (t) {
                for (;;) {
                  switch (t.prev = t.next) {
                    case 0:
                      e = o, n = i.split("\n"), r = e, console.log("tokens ", n.length), u = C(n), t.prev = 5, u.s();
                    ...
                    case 7:
                      ...
                      return s = l.value, console.log("offset ", r, s, n), t.next = 12, a(r);
                    ...
                    case 17:
                      t.prev = 17, t.t0 = t.catch(5), u.e(t.t0);
            ...
            switch (console.log("command text ", t.insert), t.insert) {
      ...
      value: function value() {
        ...
        if (t) {
          var e = B(this.quillJS.getLine(t.index), 2),
              n = e[0],
              r = e[1],
      ...
      value: function value(t) {
        ...
        if (console.log("Hello~ ", function (t) {
          ...
          var n = B(this.quillJS.getLine(e.index), 2),
              r = n[0],
              o = n[1];
          ...
          if (r && !(o < 0)) {
            ...
            if (console.log("text ", l), e.length = e.index++, this.isValid(l, r.domNode.tagName)) {
